...
<div class="container" style=" border-radius: 10px>
   <div class="row">
       ...
       <div class="col-lg-9"> 
           ...
           <div class="well" >
               ...
               <form role="form" action="comment/{{$post->id}}" method="post"  >
                   ...
                   <div class="form-group">
                       <textarea class="form-control" rows="3" name="NoiDung" style="font-size: 14px"></textarea>
                   </div>
           ...
           <!-- Comment -->
           <div class="repcomment" style="font-size: 14px">
                        ...
                        <a id ="dislike{{$cm->id}}">
                            ...
                            @else 
                                <button id="btnDadisLike" name="btnDadisLike" value="{{$cm->id}}" class="btn-dadislikecm" >
                                    <font color="0000FF">DisLike</font>
                                </button>
                         ...
                         <a id ="dislike{{$cmchil->id}}">
                            {{$count_dislikeCmchil}}
                             @if ($dislike_rep_check == true)
                                 ...
                                 <button id="btndisLikecmrep" name="btndisLikecmrep" value="{{$cmchil->id}}" class="btn-dislikecm-rep" style="font-size: 14px">
                                     DisLike
                                 </button>
                             
                             @else 
                                 <button id="btnDadisLikecmrep" name="btnDadisLikecmrep" value="{{$cmchil->id}}" class="btn-dadislikecm-rep" style="font-size: 14px" >
                                    <font color="0000FF">DisLike</font>
                                 </button>
       ...
       <div class="col-md-3" style="font-size: 14px">
           ...
           <div class="panel panel-default">
               <div class="panel-heading" style="font-size: 16px"><b>Related news</b></div>
           ...
           <div class="panel panel-default">
               <div class="panel-heading" style="font-size: 16px"><b>
      Latest News</b></div>
               <div class="panel-body">
