...
Route::group(['prefix'=>'admin','middleware'=>'adminlogin'],function(){
    ...
    Route::group(['prefix'=>'keyword'],function(){
        Route::get('danhsach',[KeywordController::class,'getDanhSach']);
        Route::get('xoa/{id}',[KeywordController::class,'xoa']);
        Route::get('sua/{id}',[KeywordController::class,'getSua']);
        Route::post('sua/{id}',[KeywordController::class,'postSua']);
        Route::get('them',[KeywordController::class,'getThem']);
        Route::post('them',[KeywordController::class,'postThem']);
    });
